...
|---|---|---|
| [`fua-morphometrics`](https://github.com/Emanuel-Agu/fua-morphometrics) | Python | Replication and extension of Sapena et al. (2020): spatio-temporal urban morphometrics for 599 Functional Urban Areas across 32 countries, validated at >99.99% against the published results. [doi:10.5281/zenodo.19635759](https://doi.org/10.5281/zenodo.19635759) |
| [`fragmetrics`](https://github.com/Emanuel-Agu/fragmetrics) | Python | Open-source landscape fragmentation metrics — a `geopandas` reimplementation of the IndiFrag toolbox, no ArcGIS dependency. [doi:10.5281/zenodo.19635208](https://doi.org/10.5281/zenodo.19635208) |
...
| [`degurba`](https://github.com/Emanuel-Agu/degurba) | — | Visual reference for the DEGURBA (Degree of Urbanization) classification — NYC / Minneapolis examples across 1975–2020 |
